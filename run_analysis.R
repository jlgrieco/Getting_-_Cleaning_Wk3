setwd("~/R/Coursera/getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset")
#Pull all files to UCI HAR Dataset from subfolders
...
write.table(Finalized, "Final.txt", row.name=FALSE)
